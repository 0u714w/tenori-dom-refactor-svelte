...
import { getContext, setContext, onDestroy } from '../svelte/internal.js';
...
function applyDefinitions(e, r, n) {
  for (var i = 0; i < n.length; i++) {
    if (n[i].kind === Kind.FRAGMENT_DEFINITION) {
      var a = n[i].name.value;
      var u = stringifyDocument(n[i]);
      if (!e.has(a)) {
        e.set(a, u);
        r.push(n[i]);
      } else if (e.get(a) !== u) {
...
function gql() {
  ...
  applyDefinitions(r, i, keyDocument(o).definitions);
...
function subscriptionExchange(e) {
  ...
  return function(e) {
    ...
    return function(e) {
      ...
      }))(filter$1(isSubscriptionOperation)(n));
      var p = o(filter$1((function(e) {
...
function subscription(t, e) {
  ...
  var r = N((function(e) {
    ...
    return concat$1([ fromValue$1({
      fetching: !0
    }), n.executeSubscription(e, t.context), fromValue$1({
      fetching: !1
    }) ]);
  }))(toSource(t))));
  onDestroy(r.unsubscribe);
  return t;
}
...
export { Client, i as CombinedError, cacheExchange, composeExchanges, createClient, createRequest, debugExchange, dedupExchange, Q as defaultExchanges, errorExchange, $ as fallbackExchangeIO, fetchExchange, formatDocument, getClient, getOperationName, gql, initClient, makeErrorResult, makeOperation, makeResult, maskTypename, mutation, operationStore, query, setClient, ssrExchange, stringifyVariables, subscription, subscriptionExchange };
