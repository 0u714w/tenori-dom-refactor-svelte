import './VolumeControl.css.proxy.js';
/* src/VolumeControl.svelte generated by Svelte v3.38.2 */
import {
	SvelteComponent,
	append,
	attr,
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(i1, "class", "fas fa-volume-up");
...
function instance($$self) {
	...
	const click_handler = () => volumeChange(0);
	const click_handler_1 = () => volumeChange(1);
	return [volumeChange, click_handler, click_handler_1];
}
