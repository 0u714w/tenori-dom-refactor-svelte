import './WaveControl.css.proxy.js';
/* src/WaveControl.svelte generated by Svelte v3.38.2 */
import {
	SvelteComponent,
	append,
	attr,
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(i1, "class", "fas fa-wave-square");
...
function instance($$self) {
	...
	const click_handler = () => waveChange(1);
	const click_handler_1 = () => waveChange(0);
	return [waveChange, click_handler, click_handler_1];
}

class WaveControl extends SvelteComponent {
	constructor(options) {
		super();
